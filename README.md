...
To install from the latest github repo, run :

```
haxelib git uhu https://github.com/skial/uhu.git src
```
...
> Delko was created because of afew client's particular needs.
