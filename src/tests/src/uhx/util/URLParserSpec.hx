 ...
 * @author Skial Bainn
 */
class URLParserSpec extends TestCase {

	public function new() {
		super();
	}
	
	public var v:URLParser;
	public var e:String;
	...
	public function testURL_blank_query() {
		...
		v = 'http://www.test.com/index.html?arr=1&arr=&arr=2'.asURL();
		assertEquals(e, v.toString());
	}
	...
	public function testURL_delete_path() {
		e = 'http://test.com';
		v = 'http://test.com/index.html'.asURL();
		v.path = '';
		assertEquals(e, v.toString());
	}
	...
	public function testURL_swap_query() {
		...
		v = 'www.test.com?this=that&a=1&b=2;c=3'.asURL();
		v.query.remove('a');
		v.query.remove('b');
		v.query.set('something', ['else']);
		assertEquals(e, v.toString());
	...
	public function testURL_change_fragment() {
		...
		v = 'a/b/c/123.html#content'.asURL();
		v.fragment = 'about';
		assertEquals(e, v.toString());
	}
