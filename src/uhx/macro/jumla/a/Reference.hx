 ...
 * @author Skial Bainn
 */
abstract Reference<T>(T) from T to T {
	...
	private function get_fkind():Int return this.fieldType();
	
	private var efield(get, set):Field;
	private function get_efield():Field return untyped this;
	private inline function set_efield(v:Field):Field return untyped this = v;
	
	private var cfield(get, set):ClassField;
	private function get_cfield():ClassField return untyped this;
	private inline function set_cfield(v:ClassField):ClassField return untyped this = v;
